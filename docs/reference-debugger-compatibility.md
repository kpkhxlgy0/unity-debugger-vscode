...
| CTRL-02b | Jump to Cursor and Set Next Statement | Jump to Cursor stops at line 1076; Set Next Statement immediately moves the yellow marker to line 1076; no warning or marker loss, and subsequent Step Over works | Not re-verified with the replacement build | reference verified; Pure pending | 2026-08-06 MyGame reference run | Keep separate from the verified targeted-step result; do not infer from unchanged source |
